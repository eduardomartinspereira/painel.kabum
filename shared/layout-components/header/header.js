...
function Header({ local_varaiable, ThemeChanger }) {
    ...
    const swichermainright = () => {
        ...
        if (
            document
                .querySelector('.switcher-backdrop')
        ...
        <Fragment>
                ...
                <div className="main-header-container container-fluid">
                    ...
                    <div className="header-content-right">
                            ...
                            >
                                <div className="p-3">
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <span
                                            className="badge bg-indigo"
                                            id="cart-data"
                                        >
                                            Items {remainingCount2}{' '}
                                            {remainingCount2 !== 1 ? '' : ''}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div
                                    className={`p-2 bg-primary-transparent d-flex justify-content-between align-items-center empty-header-item border-top ${
                                        remainingCount2 === 0
                                            ? 'd-none'
                                            : 'd-block'
                                    }`}
                                ...
                                >
                                    <div className="text-center">
                                        ...
                                        <Link
                                            href="/components/pages/e-commerce/shop"
                        ...
                        >
                            ...
                            <Dropdown.Menu
                                className="main-header-dropdown dropdown-menu dropdown-menu-start"
                                data-popper-placement="none"
                            >
                                <div className="p-3">
                                    <div className="d-flex align-items-center justify-content-between">
                                            ...
                                            (notification, index) => (
                                                ...
                                                >
                                                    <div className="d-flex align-items-start">
                                                        <div className="pe-3">
                                                            <span
                                                                className={`avatar bg-${notification.avatarcolor} rounded-3`}
                                                            >
                                                                <i
                                                                    className={
                                                                        notification.icon
                                ...
                                <div
                                    className={`p-2 empty-header-item1 border-top ${
                        ...
                        {/* Right sidebar */}
                        <div
                            className="header-element d-md-block d-none"
                            onClick={handleShow1}
                        >
                            <Link
                                href="#!"
            ...
            >
                <Tab.Container defaultActiveKey="first">
                    <Offcanvas.Header
                        closeButton
                        className="offcanvas-header border-bottom bg-light"
                    >
                        <h6
                            ...
                            <Tab.Content>
                                ...
                                >
                                    {pane1.map((item, index) => (
                                        <div
                                            key={index}
                                            className={`list d-flex align-items-center border-bottom ${item} p-3`}
                                        >
                                            <div className="">
                                                <span
                                                    className={`avatar bg-${
