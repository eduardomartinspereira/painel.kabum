!(function (t, e, n, r, o) {
    if ('customElements' in n) o();
        ...
        if (n.AWAITING_WEB_admin_POLYFILL)
            return void n.AWAITING_WEB_admin_POLYFILL.then(o);
        var a = (n.AWAITING_WEB_admin_POLYFILL = f());
        a.then(o);
        var i =
                n.WEB_admin_POLYFILL ||
                '//cdnjs.cloudflare.com/ajax/libs/webadminjs/2.0.2/webadmin-bundle.js',
            s =
                n.ES6_CORE_POLYFILL ||
