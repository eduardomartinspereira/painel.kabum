    ...
    (function (t, e, n, o) {
        ...
        function p(t, e, n, o) {
            (function i(t, e, n, o) {
                try {
                    ...
                    t.P && t.P.T(n),
                        ...
                        n['s-rc'] &&
                            (n['s-rc'].forEach((t) => t()), (n['s-rc'] = null));
                } catch (e) {
                    (t.x = !1), t.g(e, 8, n, !0);
                }
            })(t, t.b(e), e, n);
            try {
                o
                    ? e['s-init']()
                    : (n.componentDidUpdate && n.componentDidUpdate(),
                      j(t.W.get(e))),
                    ...
                    if (
                        ...
                        o && o.N && o.N[n]
                            ? (g(e, n, i),
                              s &&
                                  o.N[n].q &&
                                  y(e, o.N[n].I, i, 3 === o.N[n].B, null == i))
                            : 'ref' !== n &&
                              (g(e, n, null == i ? '' : i),
        ...
        function k(t, e, n, o, i) {
            ...
            for (i in s)
                (c && null != c[i]) ||
                    null == s[i] ||
                    $(t, r, i, s[i], void 0, o, n.l);
            for (i in c)
                (i in s &&
                    c[i] ===
                        ('value' === i || 'checked' === i ? r[i] : s[i])) ||
                    $(t, r, i, s[i], c[i], o, n.l);
        }
        function M(t, e) {
                ...
                if (
                    ...
                    (function f(u, a, d) {
                        ...
                        (Q =
                            a.c &&
                            L(e.it(a.c)) &&
                            void 0 !== a.c.ownerSVGElement),
                            (Q =
                                'svg' === a.vtag ||
                                ('foreignObject' !== a.vtag && Q)),
                            L(a.vtext)
                ...
                r = (function s(t) {
                    return Object.keys(t).reduce(
                        (e, n) => {
                            ...
                            const r = { name: n };
                            if (o.state)
                                (i = 'states'), (r.mt = o.watchCallbacks || []);
                ...
                (n.disconnectedCallback = function () {
                    (function e(t, n) {
                        if (
                            ...
                            t.P && t.P.St(n),
                                [t.s, t.At, t.k].forEach((t) => t.delete(n));
                        }
                    })(t, this);
                }),
                (n['s-init'] = function () {
            ...
            const u = { html: {} },
                ...
                m = (function v(t, e, n) {
                    ...
                    (i.M = !!i.Lt.documentElement.attachShadow),
                        e.location.search.indexOf('shadow=false') > 0 &&
                            (i.M = !1),
                        (i.Ft = (t, n, o) =>
                            t && t.dispatchEvent(new e.CustomEvent(n, o)));
                    try {
                        e.addEventListener(
                            'e',
                            null,
                ...
                queue: (e.queue = (function $(t, e) {
                    ...
                    function i() {
                        ...
                        o(f, e),
                            ...
                            (d = l.length + f.length + u.length > 0)
                                ? t.raf(i)
                                : (a = 0);
                    }
                        ...
                        if (
                            ...
                            if ((i || t.zt.set(n, (i = {})), !i[c])) {
                                let t;
                                {
                                    ...
                                    const o =
                                        n.querySelectorAll('[data-styles]');
                                    e.et(
                                        n,
                                        t,
                                        (o.length &&
                ...
                (function O(t, e, n, o, i, r) {
                    if (
                        ...
                        for (r = i.length - 1; r >= 0; r--)
                            e.componentOnReady(i[r][0], i[r][1]) &&
                                i.splice(r, 1);
