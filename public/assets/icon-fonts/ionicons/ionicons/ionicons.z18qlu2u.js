    ...
    (function (e, t) {
        ...
        function Xt(e, t) {
            nt(e, t),
                Mt
                    ? Mt.observe(e, yt)
                    : (Nt &&
                          ((e.setAttribute = Wt), (e[o] = Ot(e)), e[u](x, Lt)),
                      e[u](E, Rt)),
        ...
        function Vt() {
            for (var e, t = 0, n = at.length; t < n; t++)
                (e = at[t]),
                    M.contains(e) || (n--, at.splice(t--, 1), Jt(e, l));
        }
        function $t(e) {
        ...
        var s = 'registerElement',
            ...
            V =
                !/^force/.test(t.type) &&
                !!(X && X.define && X.get && X.whenDefined),
            $ = r.create || r,
            J =
                e.Map ||
                function () {
...
Array.from ||
    (Array.from = (function () {
        var l = Object.prototype.toString,
            h = function (c) {
                return (
                    'function' === typeof c || '[object Function]' === l.call(c)
                );
            },
            m = Math.pow(2, 53) - 1;
        return function (c) {
    ...
    if (!e.fetch) {
        ...
        if (g.arrayBuffer) {
            ...
            var z =
                ...
                function (a) {
                    return (
                        a && -1 < E.indexOf(Object.prototype.toString.call(a))
                    );
                };
        }
        ...
        (function (n, t, e, r) {
            ...
            function b(n, t, e, r) {
                ...
                try {
                    r
                        ? t['s-init']()
                        : (e.componentDidUpdate && e.componentDidUpdate(),
                          C(n.S.get(t))),
                ...
                if ('class' !== e || u)
                    if ('style' === e) {
                        ...
                        if (
                            ...
                            (e in t ||
                                (-1 !==
                                    ['object', 'function'].indexOf(typeof i) &&
                                    null !== i))
                        ) {
                            var c = n.y(t);
                            c && c.P && c.P[e]
                    ...
                    if (
                        ...
                        (function a(s, l, v) {
                            ...
                            (an =
                                l.c &&
                                V(t.un(l.c)) &&
                                void 0 !== l.c.ownerSVGElement),
                                (an =
                                    'svg' === l.vtag ||
                                    ('foreignObject' !== l.vtag && an)),
                                V(l.vtext)
                                ...
                                (function n(t, e) {
                                    for (
                                        ...
                                        if (1 === e.childNodes[r].nodeType) {
                                            if (
                                                t.y(e.childNodes[r]) &&
                                                !t.Nn.has(e.childNodes[r])
                                            )
                                                return !1;
                                            if (!n(t, e.childNodes[r]))
                                                return !1;
                                        }
                                    return !0;
                                })(n, e) &&
                ...
                xn = (function () {
                    ...
                    return (
                        ...
                        (n.prototype.wt = function (n, t, e) {
                            var r = this.dt.get(t);
                            return (
                                r || (((r = H(n)).kt = e), this.dt.set(t, r)), r
                            );
                        }),
                        n
                    );
                ...
                (function Sn(n, t, e, r, u, o, f) {
                    ...
                    var w = { html: {} },
                        ...
                        E = (function C(n, t, e) {
                            ...
                            (i.j = !!i.In.documentElement.attachShadow),
                                t.location.search.indexOf('shadow=false') > 0 &&
                                    (i.j = !1),
                                'function' != typeof t.CustomEvent &&
                                    ...
                                    (t.CustomEvent.prototype =
                                        t.Event.prototype)),
                                (i.xt = function (n, e, r) {
                                    return (
                                        n &&
                                        n.dispatchEvent(new t.CustomEvent(e, r))
                                    );
                                });
                            try {
                                t.addEventListener(
                    ...
                    E.j,
                        ...
                        (t.emit = function (n, e, r) {
                            return E.xt(
                                n,
                                t.eventNameFn ? t.eventNameFn(e) : e,
                                r
                            );
                        }),
                        (O.h = v),
                        ...
                        (function B(n, t, e, r, i, u) {
                            if (
                                ...
                                for (u = i.length - 1; u >= 0; u--)
                                    t.componentOnReady(i[u][0], i[u][1]) &&
                                        i.splice(u, 1);
