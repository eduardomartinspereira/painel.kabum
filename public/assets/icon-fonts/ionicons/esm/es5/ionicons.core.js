...
function c(n, t, e, r, i, o) {
    if ((n.a.delete(t), !n.l.has(t))) {
        if (((r = n.v.get(t)), (e = !r))) {
            if (
                ((i = n.u.get(t)) && i.$rendered && (i['s-rn'] = !0),
                i && !i['s-rn'])
            )
                return (
...
function p(n, t, e, r, i) {
    ...
    (u && (!e || 'false' === e)) || i
        ...
        : 'function' != typeof e &&
          (u && (e = ''),
          o ? n.setAttributeNS(I, W(t), e) : n.setAttribute(t, e));
}
            ...
            if (
                ...
                c && c.C && c.C[e]
                    ? (m(t, e, i),
                      u &&
                          c.C[e].R &&
                          p(t, c.C[e].F, i, 3 === c.C[e].H, null == i))
                    : 'ref' !== e &&
                      (m(t, e, null == i ? '' : i),
            ...
            return Object.keys(n).reduce(
                function (t, e) {
                    var r,
                        ...
                        o = { name: e };
                    if (i.state)
                        (r = 'states'), (o.pn = i.watchCallbacks || []);
                        ...
                        i.type &&
                            ((u = i.type),
                            'function' == typeof i.type && (u = i.type.name)),
                        ...
                        delete e['s-hmr-load'],
                            (function r(n, t, e) {
                                n.On.has(e) ||
                                    ...
                                    t.y &&
                                        t.y.listeners &&
                                        ((t.dn = t.y.listeners.map(function (
                                            n
                                        ) {
                                            return {
                                                e: n.method,
                    ...
                    if ((l || t.Un.set(a, (l = {})), !l[f])) {
                        ...
                        if (
                            ...
                            e.O(v, 'data-style-tag', r.n),
                                ...
                                i['s-sc'] &&
                                    e.O(v, 'data-style-scoped', 'true');
                            var d = a.querySelectorAll('[data-styles]');
                            e.tn(
                                a,
                                v,
                                (d.length && d[d.length - 1].nextSibling) ||
                                    a.firstChild
                            );
                        }
                    }
        ...
        (function E(n, t, e, r, i, o) {
            if (
                ...
                for (o = 0; o < r.length; o++)
                    if (!e[r[o]].componentOnReady) return;
...
function applyPolyfills(n, t) {
    n.nt = (function () {
        ...
        function s(n, t) {
            n.tt === _ &&
                ((n.et = t), (n.tt = x), 0 !== n.ot.length && M(d, n));
        }
        function l(n, t) {
