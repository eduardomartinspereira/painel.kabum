            ...
            <Row className="row">
                    ...
                    <Card>
                        <Card.Body className="main-content-left main-content-left-mail ">
                            <Link
                                ...
                                onClick={handleShow}
                            >
                                <i className="fe fe-plus me-2"></i>Create Folder
                            </Link>
                            <div
                                ...
                                >
                                    ...
                                    <Nav.Item>
                                        <Nav.Link
                                            ...
                                            eventKey="Hidden"
                                        >
                                            <i className="fe fe-eye"></i> Hidden
                                            FIles
                                        </Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                            ...
                            <Card className=" custom-card mt-3 pb-0 mb-0 border-0">
                                <Card.Header className=" fw-bold">
                                    <i className="fe fe-hard-drive me-2"></i>
                                    Storage
                                </Card.Header>
                ...
                <Col xl={9} lg={8}>
                    ...
                    <Row>
                        <Col md={6} xl={6} xxl={3}>
                            <Card>
                                <Link href={'/admin/apps/file-manager1/'}>
                                    <Card.Body>
                            ...
                            <Col sm={6} md={4} xl={3} key={folder.id}>
                                <Card className="p-0 ">
                                    <div className="d-flex align-items-center px-3 pt-3">
                                        ...
                                        <Dropdown
                                            align={{ lg: 'end' }}
                                            className="float-end ms-auto optiondots no-caret"
                                        >
                                            <Dropdown.Toggle
                                                variant=""
                                                href="#!"
                                            ...
                                            <Dropdown.Menu>
                                                ...
                                                <Dropdown.Item
                                                    ...
                                                    href="#!"
                                                >
                                                    <i className="fe fe-share me-2"></i>{' '}
                                                    Share
                                                </Dropdown.Item>
                                                <Dropdown.Item
                                                    className="dropdown-item"
