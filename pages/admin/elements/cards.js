                    ...
                    <Card className=" custom-card">
                        <Card.Body>
                            ...
                            <p className="card-text">
                                ...
                                alteration many variations of passages of Lorem
                                Ipsum available there are so many ways to solve
                    ...
                    <Row>
                        ...
                        <Col xl={12}>
                            <Card className=" border border-success mb-3">
                                <Card.Header className=" bg-transparent border-bottom border-success">
                                    Header
                                </Card.Header>
                    ...
                    <Card className=" custom-card">
                        <Card.Header>
                            <div className="d-flex align-items-center w-100">
                                ...
                                <Dropdown
                                    className="dropdown ms-auto no-caret"
                                    align={{ lg: 'start' }}
                                >
                                    <Dropdown.Toggle
                                        variant=""
                        ...
                        <Card.Body>
                            If you are going to use, you need to be sure there
                ...
                <Col xl={3}>
                    <Card className=" custom-card">
                        ...
                        <Card.Body className=" pt-3">
                            <div className="fw-semibold fs-15 mb-2">
                                Very Great!
                            </div>
                ...
                <Col xl={3}>
                    <Card className=" custom-card text-center">
                        ...
                        <Card.Body className=" pt-1">
                            ...
                            <p className="mb-4 text-muted fs-11">
                                Web Developer
                            </p>
                        ...
                        <Card.Header className="justify-content-between">
                            ...
                            >
                                <Modal.Header>
                                    ...
                                    >
                                        <i className="fe fe-x ms-auto lh-1"></i>
                                    </span>
                                </Modal.Header>
                                <Modal.Body>
                            ...
                            <Card className=" custom-card w-75">
                                ...
                                <Card.Body>
                                    <div className="card-text">
                                        ...
                                        adipisicing elit. Id nostrum omnis
                ...
                <Col xl={4}>
                    <Card className=" custom-card overlay-card">
                        ...
                        <div className="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                            ...
                            <Card.Footer className=" text-fixed-white">
                                Last updated 3 mins ago
                            </Card.Footer>
                        </div>
                    </Card>
                            ...
                            <Col md={8}>
                                ...
                                <Card.Body>
                                    ...
                                    <p className="card-text mb-3">
                                        This is a wider card with suppo rting
                    ...
                    <Card className=" border border-primary custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">
                                Home Page Design
                                <Link href="#!">
                                    <i className="bi bi-plus-square float-end text-primary fs-18"></i>
                                </Link>
                            </p>
                    ...
                    <Card className=" border border-secondary custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">
                                Landing Page Design
                                <Link href="#!">
                                    <i className="bi bi-plus-square float-end text-secondary fs-18"></i>
                                </Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                    ...
                    <Card className=" border border-warning custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">
                                Update New Project
                                <Link href="#!">
                                    <i className="bi bi-plus-square float-end text-warning fs-18"></i>
                                </Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                    ...
                    <Card className=" border border-info custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">
                                ...
                                <Link href="#!">
                                    <i className="bi bi-plus-square float-end text-info fs-18"></i>
                                </Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                                <span className="badge bg-info-transparent">
                    ...
                    <Card className=" border border-danger custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">
                                ...
                                <Link href="#!">
                                    <i className="bi bi-plus-square float-end text-danger fs-18"></i>
                                </Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                                <span className="badge bg-primary-transparent">
                    ...
                    <Card className=" border border-success custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">
                                ...
                                <Link href="#!">
                                    <i className="bi bi-plus-square float-end text-success fs-18"></i>
                                </Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                                <span className="badge bg-danger-transparent">
                    ...
                    <Card className=" border border-light custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">
                                New Employees
                                <Link href="#!">
                                    <i className="bi bi-plus-square float-end text-default fs-18"></i>
                                </Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                                <span className="badge bg-warning-transparent">
                    ...
                    <Card className=" border border-dark custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">
                                ...
                                <Link href="#!">
                                    <i className="bi bi-plus-square float-end text-dark fs-18"></i>
                                </Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                                <span className="badge bg-primary-transparent">
                                ...
                                <Row className=" g-0">
                                    <Col md={8}>
                                        <Card.Body>
                                            ...
                                            <p className="card-text mb-0">
                                                This is a wild animal with
                                                supporting tactics and are very
                                                efficient at kill,they are very
                                                Dangerous.
                                            </p>
                                            <p className="mb-0 card-text">
                                                Fox lives mainly in forests and
                                                are well known for their hunting
                                                skills.
                                            </p>
                                        </Card.Body>
                                        <Card.Footer>
