            ...
            <Row className="about-main mb-5">
                <Col lg={8} md={8} sm={12} className="text-center">
                    <h1 className="mb-3 fw-semibold fs-46">
                        Hello! This is{' '}
                        <span className="text-primary fs-56 text-transparent">
                            Nowa.
                        </span>
                    </h1>
                    ...
                    <p className="leading-normal  fs-16">
                        ...
                        of Lorem Ipsum you are going to use a passage of Lorem
                        Ipsum
                    </p>
                </Col>
            </Row>
            ...
            <Row className="py-5 about-motto pt-0">
                <Col lg={8} md={8} sm={12}>
                    <div className="text-justify">
                        <div className="text-dark fs-26 font-weight-semibold">
                            Our Motto
                        </div>
                        <p className="fs-14 mb-4">
                            Lorem ipsum dolor, sit amet consectetur adipisicing
                            elit. Quibusdam similique provident Lorem ipsum
                            dolor sit amet consectetur adipisicing elit. Natus,
                            aliquam voluptas repellat eum beatae veniam, cumque
                            eligendi earum praesentium, in corrupti
                            reprehenderit cum architecto quisquam? Quibusdam
                            ...
                            <div className="d-flex mb-4">
                                ...
                                <div className="ms-4">
                                    ...
                                    <p>
                                        ...
                                        adipisicing elit. Adipisci quos sint,
                                        officia vel ab perferendis, dolores
                                        placeat dolor aliquam debitis eius,
                                        illum ullam ratione blanditiis fugiat
                            ...
                            <div className="d-flex mb-4">
                                ...
                                <div className="ms-4">
                                    ...
                                    <p>
                                        Lorem ipsum dolor sit amet consectetur
                                        adipisicing elit. Adipisci quos sint,
                                        officia vel ab perferendis illum ullam
                                        ratione blanditiis fugiat omnis beatae
                                        odio vitae!
                                    </p>
                                </div>
                            </div>
                ...
                <Col lg={6} xl={3} md={6} sm={12}>
                    <Card className=" p-3">
                        <Card.Body>
                            ...
                            <div className="fs-16 text-center font-weight-semibold">
                                Rosen Berg
                            </div>
                            ...
                            <div className="text-center fs-14 mb-3">
                                Lorem ipsum dolor, sit amet consectetur
                                adipisicing elit. Quibusdam similique provident
                                !
                            </div>
                            <p className="text-center fs-16 mb-0">
