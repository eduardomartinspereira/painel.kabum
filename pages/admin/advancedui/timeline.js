                                    ...
                                    <div className="timeline-panel">
                                        ...
                                        <div className="timeline-footer d-flex align-items-center flex-wrap">
                                            ...
                                            <span className="ms-auto">
                                                <i className="fe fe-calendar text-muted me-1 d-inline-flex"></i>
                                                19 Oct 2020
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="timeline-panel">
                                        ...
                                        <div className="timeline-body">
                                            <p>
                                                ...
                                                Babblely odeo kaboodle quora
                                                plaxo ideeli hulu weebly
                                                balihoo....
                                            </p>
                                            <Link
                                                href="#!"
                                                className="btn ripple btn-primary mb-3"
                                            >
                                                Read more
                                            </Link>
                                        </div>
                                    ...
                                    <div className="timeline-panel">
                                        ...
                                        <div className="timeline-body">
                                            <p>
                                                ...
                                                Amet cupiditate, delectus
                                                deserunt doloribus earum eveniet
