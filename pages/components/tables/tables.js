...
const Tables = () => {
	...
	return (
		<Fragment>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Hoverable Rows" customCardClass="custom-card" customCardBodyClass="px-0" code={table22}>
						<div className="table-responsive">
											...
											<th scope="row">
												<div className="form-check">
													<Form.Check
														...
														className=""
														type="checkbox"
														checked={idx.name === "Zelensky" ? checked : false} // Check Zelensky checkbox based on state
