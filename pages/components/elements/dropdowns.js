			...
			<Row>
				...
				<Col xl={3}>
					<ShowCode title="Dropup right" customCardClass="custom-card" customCardBodyClass="" code={dropdown9}>
						<div className="example">
							<Dropdown className="btn-group dropend my-1 me-2"  drop="end" align={ {lg: "start"}}>
								<Dropdown.Toggle variant='' type="button" className="btn btn-primary dropdown-toggle"
									data-bs-toggle="dropdown" aria-expanded="false">
									Dropright
								</Dropdown.Toggle>
			...
			<Row>
				...
				<Col xl={4}>
					<ShowCode title="Responsive alignment end" customCardClass="custom-card" customCardBodyClass="responsive-dropdown" code={dropdown22}>
						<div className="example">
							<div className="btn-group ">
								<DropdownButton variant="secondary" className="text-wrap" as={ButtonGroup} align={{ lg: "end" }} title="Left-aligned but right aligned when large screen"  >
				...
				<Col xl={4}>
					<ShowCode title="Responsive alignment left" customCardClass="custom-card" customCardBodyClass="responsive-dropdown" code={dropdown23}>
						<div className="example">
							<div className="btn-group">
								<DropdownButton variant="info" as={ButtonGroup} align={{ lg: "start" }} title="Left-aligned but right aligned when large screen" className=" text-wrap" >
									<Dropdown.Item href="#!">Action</Dropdown.Item>
									<Dropdown.Item href="#!">Another action</Dropdown.Item>
									<Dropdown.Item href="#!">Something else here
									</Dropdown.Item>
