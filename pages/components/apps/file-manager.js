...
import { Breadcrumb, Button, Card, Col, Dropdown, Form, Modal, Nav, Pagination, Row } from "react-bootstrap";
import Link from "next/link";
import Seo from "../../../shared/layout-components/seo/seo";
import Pageheader from "../../../shared/layout-components/pageheader/pageheader";
import { Fragment } from "react";
import { filefolders } from "../../../shared/data/apps/filemanagerdata";
				...
				<Col lg={4} xl={3}>
					<Card >
						<Card.Body className="main-content-left main-content-left-mail ">
							<Link className="btn btn-primary btn-compose" id="btnCompose" data-bs-target="#Vertically" data-bs-toggle="modal" href="#!" onClick={handleShow}><i className="fe fe-plus me-2"></i>Create Folder</Link>
							<div className="modal-dialog modal-dialog-centered" role="document">
								<Modal centered show={show} onHide={handleClose} className="" id="Vertically">
									<div className=" modal-content-demo">
										...
										<Modal.Footer className="modal-footer">
											<Button variant="primary" className="btn ripple" type="button" >Add</Button>
											<button variant="secondary" className="btn ripple btn-secondary" data-bs-dismiss="modal" type="button" onClick={handleClose}>Cancel</button>
										</Modal.Footer>
									</div>
								</Modal>
							</div>
							...
							<Card className=" custom-card mt-3 pb-0 mb-0 border-0">
				...
				<Col xl={9} lg={8}>
					<Row >
						...
						<div className="col-6 col-auto">
							<div className="input-group mb-2">
								<input type="text" className="form-control text-truncate" placeholder="Search folder....." aria-label="Search folder....." aria-describedby="button-addon2" />
					...
					<Row>
						{filefolders.map((folder) => (
							<Col sm={6} md={4} xl={3} key={folder.id}>
								<Card className="p-0 ">
									<div className="d-flex align-items-center px-3 pt-3">
										...
										<Dropdown align={{ lg: "end" }} className="float-end ms-auto optiondots no-caret">
									...
									<Card.Body className="pt-0 text-center">
										...
										<h6 className="mb-1 font-weight-semibold">{folder.heading}</h6>
										<span className="text-muted tx-11">{folder.main}</span>
									</Card.Body>
								</Card>
							</Col>
						))}
