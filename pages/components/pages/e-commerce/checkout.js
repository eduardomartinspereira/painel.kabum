...
import { Button, Card, Col, Form, Nav, Row, Tab, TabContent, TabPane } from "react-bootstrap";
import Select from "react-select";
import Link from "next/link";
import Pageheader from "../../../../shared/layout-components/pageheader/pageheader";
import Seo from "../../../../shared/layout-components/seo/seo";
import { country, State } from "../../../../shared/data/pages/e-commerce/checkoutdata";
					...
					<Card className="custom-card">
						<Card.Body className=" p-0 product-checkout">
							<Tab.Container id="left-tabs-example" activeKey={activeTab} onSelect={(tab) => setActiveTab(tab)}>
								...
								<Nav variant="pills" className=" nav-tabs tab-style-2 d-sm-flex d-block border-bottom border-block-end-dashed" id="myTab1" role="tablist">
									<Nav.Item>
												...
												<div className="your-order" id="shipped-tab-pane">
													...
													<div className="product">
														<div className="item flex-wrap px-4 gap-2">
															<div className="left flex-wrap gap-2"> <Link href="#!" className="thumb rounded-3"> <img src={"../../../../assets/images/ecommerce/23.jpg"} alt="" className="rounded-3" /> </Link>
														...
														<div className="item flex-wrap px-4 gap-2 mb-0">
															<div className="left flex-wrap gap-2"> <Link href="#!" className="thumb rounded-3"> <img src={"../../../../assets/images/ecommerce/17.jpg"} alt="" className="rounded-3" /> </Link>
																<div className="purchase">
